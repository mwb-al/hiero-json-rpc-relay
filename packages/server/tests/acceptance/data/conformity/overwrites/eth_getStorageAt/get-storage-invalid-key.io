...
// https://github.com/ethereum/execution-apis/blob/main/tests/eth_getStorageAt/get-storage-invalid-key.io

>> {"jsonrpc":"2.0","id":1,"method":"eth_getStorageAt","params":["0xaa00000000000000000000000000000000000000","0xasdf","latest"]}
<< {"jsonrpc":"2.0","id":1,"error":{"code":-32602,"message":"unable to decode storage key: hex string invalid"}}
